    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-amber-900 mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/registrarse"
              className="w-full sm:w-auto px-8 py-3 bg-amber-700 text-white text-lg rounded-xl hover:bg-amber-800 transition shadow-lg text-center"
            >
              Soy un bar / restaurante
            </Link>
            <Link
              to="/registrarse"
              className="w-full sm:w-auto px-8 py-3 bg-white text-amber-800 text-lg border border-amber-300 rounded-xl hover:bg-amber-50 transition shadow-lg text-center"
            >
              Soy un proveedor
            </Link>
          </div>
